...
indicators = [
    'EN.GHG.ALL.MT.CE.AR5', 'EN.GHG.ALL.PC.CE.AR5', 'EN.GHG.CO2.MT.CE.AR5',
    'EN.GHG.CO2.PC.CE.AR5', 'EN.ATM.PM25.MC.M3', 'EN.GHG.CO2.RT.GDP.PP.KD',
    'NY.GDP.PCAP.PP.KD', 'NY.GDP.MKTP.KD.ZG', 'SP.DYN.LE00.IN',
    'SH.DYN.MORT', 'SH.XPD.CHEX.GD.ZS', 'SH.XPD.CHEX.PC.CD', 'AG.LND.FRST.ZS',
    'SH.H2O.SMDW.ZS', 'SH.STA.AIRP.P5', 'EG.FEC.RNEW.ZS', 'SH.STA.WASH.P5',
    'SP.POP.GROW', 'SP.POP.TOTL', 'SP.URB.TOTL.IN.ZS', 'EN.POP.DNST'
]
